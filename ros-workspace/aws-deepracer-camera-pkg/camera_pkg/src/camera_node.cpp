...
CameraNode::CameraNode(const std::string & node_name, const std::vector<int> cameraIdxList)
    : Node(node_name),
...
void CameraNode::scanCameraIndex(const std::vector<int> cameraIdxList) {
...
void CameraNode::videoProducerStateHdl(const std::shared_ptr<rmw_request_id_t> request_header,
